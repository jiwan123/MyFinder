...
public class RoadsideBaseAdapter extends BaseAdapter {
    Context context;
    List<RoadsideAssistance> rowItems;

    public RoadsideBaseAdapter(Context context, List<RoadsideAssistance> items) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        final RoadsideAssistance rowItem = (RoadsideAssistance) getItem(position);
        ...
        holder.callBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (ActivityCompat.checkSelfPermission(RoadsideBaseAdapter.this.context, Manifest.permission.CALL_PHONE) != PackageManager.PERMISSION_GRANTED) {
                    return;
                }
                RoadsideBaseAdapter.this.context.startActivity(callIntent);
            }
        });
