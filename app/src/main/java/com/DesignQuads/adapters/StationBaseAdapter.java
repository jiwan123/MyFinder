...
public class StationBaseAdapter extends BaseAdapter {
    Context context;
    List<Station> rowItems;

    public StationBaseAdapter(Context context, List<Station> items) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        final Station rowItem = (Station) getItem(position);
        ...
        holder.callBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (ActivityCompat.checkSelfPermission(StationBaseAdapter.this.context, Manifest.permission.CALL_PHONE) != PackageManager.PERMISSION_GRANTED) {
                    return;
                }
                StationBaseAdapter.this.context.startActivity(callIntent);
            }
        });
