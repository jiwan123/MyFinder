...
public class RoadSideAddress extends AppCompatActivity {
                                         ...
                                         String WEamOpening ,String WEam_pm_opening, String WEpmClosing,String WEam_pm_closing)
    {
        ...
        DataFuelOpeningHrs OpenHours = new DataFuelOpeningHrs(RoadAssisId,WDamOpening+" "+WDam_pm_opening,
    ...
    private void writeNewRoadSide(String PlaceName, String LocationPhone) {
        ...
        DataRoadAssis station = new DataRoadAssis(PlaceName,LocationPhone,user_id);
        mDatabase.child("RoadSide_Assistance").child(RoadAssisId).setValue(station);
